...
<div class="d-sm-flex align-items-center justify-content-between mb-3 flex">
    <h2 class="h3 mb-0 text-gray-800 line-1 size-1-3-rem"></h2>
    <a class="add-iteam" href="admin/ladipage/add"><button class="btn-success form-control" type="button"><i class="fa fa-plus" aria-hidden="true"></i> Thêm mới</button></a>
</div>
<div class="row">
    <div class="col-xl-12 col-lg-12">
        <div class="card shadow mb-4">
            ...
            <div class="card-body mobile-hide">
                <form action="admin/ladipage/search" class="search" method="post"><input type="hidden" name="_token" value="{{csrf_token()}}" />
            ...
            <div class="tab-content ">
                <div class="tab-pane overflow" id="all">
                    <table class="table">
                        <form method="post" action="admin/ladipage/delete_all"> <input type="hidden" name="_token" value="{{csrf_token()}}" />
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr id="articles">
                                ...
                                <td class="thumbnail-img">
                                    {!! isset($val->img) ? '<img data-action="zoom" src="data/ladipage/'.$val->img.'" />' : '<img data-action="zoom" src="'.$val->img2.'" />' !!}
                                </td>
                                <td>
                                    <a href="admin/ladipage/edit/{{$val->id}}">{{$val->name}}</a>
                                </td>
                                <td>
                                ...
                                <td class="d-flex">
                                    <a href="admin/ladipage/double/{{$val->id}}" class="mr-2"><i class="far fa-copy"></i></a>
                                    <a href="admin/ladipage/edit/{{$val->id}}" class="mr-2"><i class="fas fa-edit" aria-hidden="true"></i></a>
                                    <a onclick="dell()" href="admin/ladipage/delete/{{$val->id}}"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
