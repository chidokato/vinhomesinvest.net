...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow fixed">
    ...
    <ul class="navbar-nav ">
        <li class="nav-item"> <a class="nav-link line-1" href="admin/themes/list" ><i class="fa fa-chevron-left" aria-hidden="true"></i> <span class="mobile-hide">Quay lại trang trước</span> </a> </li>
    </ul>
